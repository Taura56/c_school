...
<table width="100%" border="0" bgcolor="white">
  <tr>
    ...
    <fieldset><legend align="center">Enter Learners Details and click on SAVE </legend>
      <legend align="center">
      <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
        <table align="center" bgcolor="e6e6fa">
          <tr valign="baseline">
            <td nowrap="nowrap" align="right">Adm No:</td>
            <td><input type="text" name="AdmNo" value="" size="32" required/></td>
          </tr>
          <tr valign="baseline">
          ...
          <tr valign="baseline">
            ...
            <td><input type="text" name="DoB" value="" size="32" required/></td>
          </tr>
          <tr valign="baseline">
          ...
          <tr valign="baseline">
            <td nowrap="nowrap" align="right">Year Of Admission:</td>
            <td><input type="text" name="YearOfAdm" value="" size="32" required/></td>
          </tr>
          <tr valign="baseline">
...
?>
          ...
          <tr valign="baseline">
            ...
            <td><input type="text" name="LearnerMode" value="" size="32" required/></td>
          </tr>
          <tr valign="baseline">
          ...
          <tr valign="baseline">
            ...
            <td align="left"><input type="checkbox" name="Status" value="" size="50" required/></td>
          </tr>
          <tr valign="baseline">
