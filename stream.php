...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO stream (streamID, streamName, gradeCode, capacity) VALUES (%s, %s, %s, %s)",
                       GetSQLValueString($_POST['streamID'], "int"),
                       GetSQLValueString($_POST['streamName'], "text"),
                       GetSQLValueString($_POST['gradeCode'], "int"),
...
<table width="100%" border="0" bgcolor="white">
  <tr>
    ...
    <fieldset>
      <legend align="center">Enter The Stream Deatails and click SAVE</legend>
      <legend align="center">
      <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
        <table align="center" bgcolor="e6e6fa">
          <tr valign="baseline">
            <td nowrap="nowrap" align="right">Stream ID:</td>
            <td><input type="text" name="streamID" value="" size="32" required/></td>
          </tr>
          <tr valign="baseline">
            <td nowrap="nowrap" align="right">Stream Name:</td>
            <td><input type="text" name="streamName" value="" size="32" required/></td>
          </tr>
          <tr valign="baseline">
...
?>
          ...
          <tr valign="baseline">
            ...
            <td><input type="text" name="capacity" value="" size="32" required/></td>
          </tr>
          <tr valign="baseline">
