...
mysql_select_db($database_conn, $conn);
$query_Recordset1 = "SELECT assessment.AssessmentDescription, assessment.Term FROM assessment WHERE assessment.AssessmentCode=102 OR assessment.AssessmentCode=103";
...
<table width="100%" border="0" bgcolor="white">
  <tr>
    ...
    <fieldset>
      <legend align="center">
    Chose the type of result and click display
    </legend>
      <form action="marksheet.php" method="post">
  <fieldset>
    <p>
      <select name="AssessmentDescription">
        <option>Choose results type</option>
        <?php do {  ?>
        <option value="<?php echo $row_Recordset1['AssessmentDescription']?>"><?php echo $row_Recordset1['AssessmentDescription']?></option>
        <?php
    ...
    <p>
      <input type="submit" name="viewMarksheet" value="View Marksheet" />
    </p>
  </fieldset>
</form>
    </fieldset> 
